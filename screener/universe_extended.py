...
MID_CAP = [
    ...
    "POONAWALLA",
    # IT/Services
    "MPHASIS", "COFORGE", "OFSS", "PERSISTENT",
    "KPITTECH", "TATAELXSI", "LTTS",
    # FMCG / Consumer
    "PGHH", "EMAMILTD", "JUBLFOOD", "PAGEIND", "PRESTIGE",
    "IDEAFORGE", "DIXON",
    # Auto
    "ASHOKLEY", "BHARATFORG", "MOTHERSON", "BALKRISIND",
    ...
    # Metals/Chemicals
    "SAIL", "NATIONALUM",
    "DEEPAKNTR", "AARTIIND", "NAVINFLUOR", "GUJFLUORO",
    ...
    "CONCOR", "GMRINFRA", "IRB", "RVNL",
    # Telecom/Misc
    "INDHOTEL", "NAUKRI", "INDIANB", "UNIONBANK",
    "HDFCAMC", "ABCAPITAL", "PEL",
    "JUBLPHARMA", "GLAND",
]
